...
function showRegisterPanel(){
 ...
 <button type="button" class="gold" onclick="sendOtp()">Verify mobile & create account</button><button type="button" class="linkbtn" onclick="auth()">← Back to Sign in</button></div>`);
}
