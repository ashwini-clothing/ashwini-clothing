...
function session(d){token=d.token;user=d.user;localStorage.setItem('ashwiniToken',token);localStorage.setItem('ashwiniUser',JSON.stringify(user));if(user.role==='admin'){const a=document.getElementById('admin');if(a)a.style.display='inline'}refreshAccountHeader();toast('Welcome to Ashwini')}
function logout(){
