...
try{db.exec(`CREATE TABLE IF NOT EXISTS site_appearance (id INTEGER PRIMARY KEY CHECK(id=1), button_bg TEXT NOT NULL DEFAULT '#CAF0F8', button_text TEXT NOT NULL DEFAULT '#03045E', button_border TEXT NOT NULL DEFAULT '#023EBA', button_font_size INTEGER NOT NULL DEFAULT 15, header_bg TEXT NOT NULL DEFAULT '#321c29', header_text TEXT NOT NULL DEFAULT '#ffffff', nav_bg TEXT NOT NULL DEFAULT '#5a2e40', nav_text TEXT NOT NULL DEFAULT '#ffffff', search_bg TEXT NOT NULL DEFAULT '#ffffff', search_button_bg TEXT NOT NULL DEFAULT '#c9a86a', search_button_text TEXT NOT NULL DEFAULT '#03045E', updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)`)}catch{}
...
const appearanceKeys=['button_bg','button_text','button_border','header_bg','header_text','nav_bg','nav_text','search_bg','search_button_bg','search_button_text'];
